...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    public static final int BATTERY_STYLE_IOS = 1;
    public static final int BATTERY_STYLE_MX = 2;
    public static final int BATTERY_STYLE_AIROO = 3;
    public static final int BATTERY_STYLE_RLANDSCAPE = 4;
    public static final int BATTERY_STYLE_RLANDSCAPE_A = 5;
    public static final int BATTERY_STYLE_RLANDSCAPE_B = 6;
    public static final int BATTERY_STYLE_LANDSCAPE = 7;
    public static final int BATTERY_STYLE_LANDSCAPE_A = 8;
    public static final int BATTERY_STYLE_LANDSCAPE_B = 9;
    public static final int BATTERY_STYLE_LANDSCAPE_CAPSULE = 10;
    public static final int BATTERY_STYLE_LANDSCAPEA = 11;
    public static final int BATTERY_STYLE_LANDSCAPEB = 12;
    public static final int BATTERY_STYLE_LANDSCAPEC = 13;
    public static final int BATTERY_STYLE_LANDSCAPED = 14;
    public static final int BATTERY_STYLE_LANDSCAPEE = 15;
    public static final int BATTERY_STYLE_LANDSCAPEF = 16;
    public static final int BATTERY_STYLE_LANDSCAPEG = 17;
    public static final int BATTERY_STYLE_LANDSCAPEH = 18;
    public static final int BATTERY_STYLE_LANDSCAPEI = 19;
    public static final int BATTERY_STYLE_LANDSCAPEJ = 20;
    public static final int BATTERY_STYLE_LANDSCAPEK = 21;
    public static final int BATTERY_STYLE_LANDSCAPEL = 23;
    public static final int BATTERY_STYLE_LANDSCAPEM = 24;
    ...
    public BatteryMeterDrawableBase(Context context, int frameColor, int style) {
        ...
        TypedArray levels = res.obtainTypedArray(R.array.qassa_batterymeter_color_levels);
        TypedArray colors = res.obtainTypedArray(R.array.qassa_batterymeter_color_values);
